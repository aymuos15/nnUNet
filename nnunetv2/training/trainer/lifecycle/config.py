"""
Configuration and initialization functions for trainer lifecycle.

This module handles:
- Optimizer and learning rate scheduler configuration
- Batch size and oversample configuration (including DDP distribution)
- Rotation, mirroring, and data augmentation parameter configuration
- Output folder setup (base, fold-specific, and cascaded folders)
- Plans and dataset.json copying for reproducibility
"""
