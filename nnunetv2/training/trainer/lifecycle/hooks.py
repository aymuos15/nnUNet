...
This module handles hooks that are called at various points during training:
- on_train_start: Initial setup before training begins
- on_train_end: Cleanup and finalization after training completes
- on_epoch_start/end: Per-epoch setup and logging
- on_train_epoch_start: Training phase setup
- on_validation_epoch_start: Validation phase setup
- on_train_epoch_end: Training epoch aggregation and logging
- on_validation_epoch_end: Validation epoch aggregation and logging
"""
...
from nnunetv2.training.runtime_utils.collate_outputs import collate_outputs
...
from .config import copy_plans_and_dataset_json, ensure_output_folder_exists
