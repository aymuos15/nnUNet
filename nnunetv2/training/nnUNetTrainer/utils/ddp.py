"""
Distributed Data Parallel (DDP) utilities for nnU-Net trainers.

This module contains utilities for initializing DDP settings, calculating batch sizes
and oversample percentages for distributed training.
"""
import numpy as np
import torch
